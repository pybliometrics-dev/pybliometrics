...
Using Scopus is not free. You need to have a license or institutional access to use it. Got to http://dev.elsevier.com/myapikey.html to register and get a key. =scopus= expects this key to be in a variable called MY_API_KEY. I recommend you create a module to define that key, something like this.

#+BEGIN_SRC python :tangle my_scopus.py
...
#+end_example
* scopus_report
This module provides a function to generate a report on a scopus search. It outputs text in org-format.
