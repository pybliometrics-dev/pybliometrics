...
DEFAULT_PATHS = {
    ...
    'NonserialTitle': BASE_PATH_SCIENCEDIRECT / 'nonserial_title',
    ...
    'ScDirSerialTitle': BASE_PATH_SCIENCEDIRECT / 'serial_title',
...
URLS = {
    ...
    'ScDirSerialTitle': RETRIEVAL_BASE + 'serial/title/issn/',
...
VIEWS = {
    ...
    "ScDirSerialTitle": ["STANDARD", "ENHANCED", "CITESCORE"],
